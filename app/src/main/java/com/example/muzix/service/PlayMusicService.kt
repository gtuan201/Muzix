...
class PlayMusicService: Service() {
    ...
    private fun sendNotification(song: Song?) {
        ...
        if (isPlaying){
            remoteViews.setOnClickPendingIntent(R.id.notification_play_pause,getPendingIntent(this, ACTION_PAUSE))
            remoteViews.setImageViewResource(R.id.notification_play_pause,R.drawable.ic_pause)
        }
        else{
            remoteViews.setOnClickPendingIntent(R.id.notification_play_pause,getPendingIntent(this, ACTION_RESUME))
            remoteViews.setImageViewResource(R.id.notification_play_pause,R.drawable.ic_play)
        }
        remoteViews.setOnClickPendingIntent(R.id.notification_cancel,getPendingIntent(this, ACTION_CLEAR))
        val bitmap = BitmapFactory.decodeResource(resources,R.drawable.muzix_logo)
